...
/// under its canonical `upstream/` spelling. Path separators are the
/// binary's job — every output site slash-normalizes (the protocol
/// records always did; the corpus summary was the one outlier, fixed).
