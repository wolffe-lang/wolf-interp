...
fn the_corpus_walk_is_green_over_the_pinned_corpus() {
    ...
    // 508 -> 514 at the v0.2.8 pin (5c729e8) (is40, wolf-lang's own tag):
    // SIX witnesses over two merges — s141's
    // `net/{writev_gather,nodelay,syscall_first}.lu` and s142's
    ...
    // 520 -> 521 at 4c60946 (is43, wolf-lang **v0.2.9**, the tag): ONE
    // arrives, none leaves — s145's `typecheck/closure_return.lu`
    // (wolf-lang#268's `[type.closure.return]`).
